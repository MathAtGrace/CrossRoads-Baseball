...
With league totals, we can now calculate the FIP (Fielding Indepent Pitching) constant. Once we have this constant, we will be able to calculate FIP for each player in the Crossroads League.
