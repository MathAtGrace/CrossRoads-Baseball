...
# Welcome
Welcome to our student research project.  The current plan is to rank players and predict games.
...
## Elos for simulation
The simulation begins with the final elo values calculated using the 2019 season and the few games played in the 2020 season.
```{r sim_begin}
tourney_probs <- c()
winners <- c()
Home_elos <- c()
