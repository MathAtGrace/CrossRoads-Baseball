...
for (x in Pitching){
  ...
  new.Best_Pitchers <- data.frame(team, FIP_name,  FIP,  IP)
...
The following is a list of the top pitchers in the Crossroads League in 2019 based on FIP.
...
datatable(Best_Pitchers, options = list(pageLength = 10))
```
