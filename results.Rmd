...
ggplot(tpark, aes(x=pf, y=0)) +
  geom_point(size = 8) + 
  annotate("segment", x = 0.7, xend = 1.4, y=0, yend=0, size = 2) +
  annotate("segment", x=0.7,xend=0.7,y=-.1,yend=0.1,size=2) +
  annotate("segment", x=1.4, xend=1.4, y=-0.1, yend=0.1, size=2) + 
